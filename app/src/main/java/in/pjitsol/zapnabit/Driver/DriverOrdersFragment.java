...
public class DriverOrdersFragment extends Fragment implements
OnBackPressListener,OnClickListener,OnItemClickListener,IAsyncTaskRunner,OnCancelListener{
	...
	private void initView(View view) {
		...
		adapter=new DriverOrdersAdapter(context,StaticConstants.historyItems);
	...
	public void FetchHistory() {
		...
		AuthCommanTask<HashMap<String, String>, ResultMessage> task = new AuthCommanTask<HashMap<String, String>, ResultMessage>(
				context,DriverOrdersFragment.this,
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		((BaseFragmentActivity) context).OnDriverOrderDEtailFragment(bundle);
